angular.module('mongolabResourceHttp', [])
    ...
    function MmongolabResourceFactory(collectionName) {
        ...
        Resource.distinct = function (field, queryJson) {
            return $http.post(dbUrl + '/runCommand', angular.merge({}, queryJson || {}, {
        ...
        Resource.prototype.$update = function () {
            return  $http.put(collectionUrl + "/" + this.$id() + '?apiKey=' + defaultParams.apiKey, angular.merge({}, this, {_id: undefined}))
